...
class h {
    ...
    private void a(int i10, int i11, byte b10) {
        ...
        a aVar2 = this.f33057a;
        while (b10 > 8) {
            b10 = (byte) (b10 - 8);
            int i12 = (i11 >>> b10) & 255;
            if (aVar2.f33058a != null) {
                if (aVar2.f33058a[i12] == null) {
                    aVar2.f33058a[i12] = new a();
                }
                aVar2 = aVar2.f33058a[i12];
            } else {
    ...
    public byte[] c(byte[] bArr) throws IOException {
        ...
        for (byte b11 : bArr) {
            ...
            i10 += 8;
            while (i10 >= 8) {
                aVar = aVar.f33058a[(b10 >>> (i10 - 8)) & 255];
                if (aVar.f33058a == null) {
                    byteArrayOutputStream.write(aVar.f33059b);
                    i10 -= aVar.f33060c;
                    aVar = this.f33057a;
                } else {
                    i10 -= 8;
        ...
        while (i10 > 0) {
            a aVar2 = aVar.f33058a[(b10 << (8 - i10)) & 255];
            if (aVar2.f33058a != null || aVar2.f33060c > i10) {
                break;
            }
            byteArrayOutputStream.write(aVar2.f33059b);
            i10 -= aVar2.f33060c;
            aVar = this.f33057a;
        }
    ...
    public void d(byte[] r8, java.io.OutputStream r9) throws java.io.IOException {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x0036:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: hd.h.d(byte[], java.io.OutputStream):void");
    }
