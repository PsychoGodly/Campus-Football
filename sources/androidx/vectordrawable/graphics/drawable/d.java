...
public class d {
    ...
    private static class a implements TypeEvaluator<e.b[]> {
        ...
        /* renamed from: a */
        public e.b[] evaluate(float f10, e.b[] bVarArr, e.b[] bVarArr2) {
            if (e.b(bVarArr, bVarArr2)) {
                if (!e.b(this.f4885a, bVarArr)) {
                    this.f4885a = e.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f4885a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f4885a;
            }
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f4867h
            r7 = r22
    ...
    private static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x003c:
            ...
            androidx.core.graphics.e$b[] r13 = androidx.core.graphics.e.d(r12)
            androidx.core.graphics.e$b[] r14 = androidx.core.graphics.e.d(r11)
        ...
        L_0x0054:
            ...
            boolean r3 = androidx.core.graphics.e.b(r13, r14)
    ...
    private static int f(TypedArray typedArray, int i10, int i11) {
        ...
        int i13 = z10 ? peekValue2.type : 0;
        if ((!z11 || !h(i12)) && (!z10 || !h(i13))) {
            return 0;
        }
        return 3;
    }
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k10 = k.k(resources, theme, attributeSet, a.f4869j);
        int i10 = 0;
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray k10 = k.k(resources, theme, attributeSet, a.f4866g);
        TypedArray k11 = k.k(resources, theme, attributeSet, a.f4870k);
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (i10 == 4) {
            i10 = (!z10 || !h(l10.type)) ? 0 : 3;
        }
        if (z10) {
            if (i10 == 0) {
                keyframe = Keyframe.ofFloat(f10, k.f(k10, xmlPullParser, "value", 0, 0.0f));
            } else if (i10 == 1 || i10 == 3) {
                keyframe = Keyframe.ofInt(f10, k.g(k10, xmlPullParser, "value", 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i10 == 0) {
            keyframe = Keyframe.ofFloat(f10);
        } else {
            keyframe = Keyframe.ofInt(f10);
        }
        int h10 = k.h(k10, xmlPullParser, "interpolator", 1, 0);
        if (h10 > 0) {
            keyframe.setInterpolator(c.b(context, h10));
        }
        k10.recycle();
        return keyframe;
    }
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f4868i
            r11 = r18
            r12 = r19
            r13 = r21
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f10, XmlPullParser xmlPullParser) {
        ...
        if (k.j(xmlPullParser, "valueFrom") && k.j(xmlPullParser, "valueTo")) {
            ...
            PropertyValuesHolder e10 = e(typedArray, g12, 5, 6, MaxReward.DEFAULT_LABEL);
            if (e10 != null) {
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f10, XmlPullParser xmlPullParser) {
        ...
        if (i11 != null) {
            ...
            s(e.e(i11), objectAnimator, f10 * 0.5f, i12, i13);
            return;
        }
