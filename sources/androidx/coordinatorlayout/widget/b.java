...
public class b {
    ...
    private static final ThreadLocal<Matrix> f2665a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f2666b = new ThreadLocal<>();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f2665a;
        ...
        ThreadLocal<RectF> threadLocal2 = f2666b;
