...
public class XiaomiHomeBadger implements a {
    ...
    private ResolveInfo f28185a;

    private void c(Context context, int i10) throws b {
        if (this.f28185a == null) {
            Intent intent = new Intent("android.intent.action.MAIN");
            intent.addCategory("android.intent.category.HOME");
            this.f28185a = context.getPackageManager().resolveActivity(intent, 65536);
        }
        if (this.f28185a != null) {
            NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
            Notification build = new Notification.Builder(context).setContentTitle(MaxReward.DEFAULT_LABEL).setContentText(MaxReward.DEFAULT_LABEL).setSmallIcon(this.f28185a.getIconResource()).build();
            try {
    ...
    public void b(android.content.Context r5, android.content.ComponentName r6, int r7) throws na.b {
        /*
            r4 = this;
            java.lang.String r0 = ""
