...
public class b {
    ...
    private static final ThreadLocal<Matrix> f25828a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f25829b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f25828a;
        ...
        ThreadLocal<RectF> threadLocal2 = f25829b;
