...
public final class zzarf implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzarf(Context context, zzaqq zzaqq) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzare zzare = new zzare(this);
            this.zzf = zzare;
            this.zzb.registerReceiver(zzare, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0038:
            ...
            com.google.android.gms.internal.ads.zzaqm r0 = r3.zzj     // Catch:{ Exception -> 0x0041 }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x0041 }
        L_0x0041:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzarf.zzi(android.view.View):void");
    }
