...
final class zzajb extends zzahj<Float> implements zzakz, RandomAccess {
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        if (a.e.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzajb.zzb, 0, this.zzb, this.zzc, zzajb.zzc);
            this.zzc = i12;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzajb.zzc) {
            return false;
        }
        float[] fArr = zzajb.zzb;
    ...
    public final /* synthetic */ zzajj zza(int i10) {
        if (i10 >= this.zzc) {
            return new zzajb(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzajb(float[] fArr, int i10, boolean z10) {
        super(z10);
        this.zzb = fArr;
        this.zzc = i10;
    }
