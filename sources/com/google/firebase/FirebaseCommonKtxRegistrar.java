...
public final class FirebaseCommonKtxRegistrar implements ComponentRegistrar {
    ...
    public static final class a<T> implements h {
        ...
        public static final a<T> f26122a = new a<>();
    ...
    public static final class b<T> implements h {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final b<T> f26123a = new b<>();
    ...
    public static final class c<T> implements h {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final c<T> f26124a = new c<>();
    ...
    public static final class d<T> implements h {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final d<T> f26125a = new d<>();
    ...
    public List<e7.c<?>> getComponents() {
        ...
        e7.c<a7.a> d10 = e7.c.c(f0.a(a7.a.class, cls)).b(r.j(f0.a(a7.a.class, Executor.class))).f(a.f26122a).d();
        m.d(d10, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        e7.c<a7.c> d11 = e7.c.c(f0.a(a7.c.class, cls)).b(r.j(f0.a(a7.c.class, Executor.class))).f(b.f26123a).d();
        m.d(d11, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        e7.c<a7.b> d12 = e7.c.c(f0.a(a7.b.class, cls)).b(r.j(f0.a(a7.b.class, Executor.class))).f(c.f26124a).d();
        m.d(d12, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        e7.c<a7.d> d13 = e7.c.c(f0.a(a7.d.class, cls)).b(r.j(f0.a(a7.d.class, Executor.class))).f(d.f26125a).d();
