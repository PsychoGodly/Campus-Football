...
/* compiled from: DocumentMask */
public final class n extends z<n, b> implements w0 {
    /* access modifiers changed from: private */
    public static final n DEFAULT_INSTANCE;
    public static final int FIELD_PATHS_FIELD_NUMBER = 1;
    private static volatile f1<n> PARSER;
    private d0.j<String> fieldPaths_ = z.F();
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0049:
                int[] r0 = f29568a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p8.n.a.<clinit>():void");
        }
    }
    ...
    private void h0() {
        d0.j<String> jVar = this.fieldPaths_;
        if (!jVar.t()) {
            this.fieldPaths_ = z.Q(jVar);
        }
    }
    ...
    public final Object D(z.f fVar, Object obj, Object obj2) {
        switch (a.f29568a[fVar.ordinal()]) {
            case 1:
                return new n();
            case 2:
                return new b((a) null);
            case 3:
                return z.S(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0001\u0000\u0001Ț", new Object[]{"fieldPaths_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                f1<n> f1Var = PARSER;
